...
router.get('/works', (req, res) => {
    ...
    let sql = 'SELECT * from works AS w LEFT JOIN user AS u ON u.uid = w.uid WHERE w.w_status = 1 order by wid desc';
